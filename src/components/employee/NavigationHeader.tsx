  ...
  return (
    <header className="bg-[rgba(252,252,252,1)] shadow-[0px_5px_15px_rgba(112,144,176,0.1)] flex w-full items-stretch gap-5 flex-wrap justify-between px-[19px] py-[11px]">
      <img
        ...
        className="aspect-[2.87] object-contain w-[129px] shrink-0"
        alt="Company Logo"
      />
      <div className="flex items-center gap-[21px] my-auto">
        ...
        />
        <div className="self-stretch w-0.5 shrink-0 h-[26px] my-auto border-[rgba(218,223,234,1)] border-solid border-2" />
        <div className="self-stretch flex items-stretch gap-3">
          <div className="flex flex-col items-stretch my-auto">
            <div className="text-[rgba(25,25,25,1)] text-sm font-bold">
              Marc Abshire
            </div>
            <div className="text-neutral-600 text-xs font-medium text-right">
              User
            </div>
          </div>
          <img
