...
export const OnboardingTasksCard = () => {
  return (
    <Card className="p-2 bg-[#1C1C1C] text-white hover:shadow-xl transition-shadow h-[280px] relative">
      <div className="flex justify-between items-center mb-1">
        <h3 className="text-[10px] font-medium">Onboarding Tasks (2/8)</h3>
      </div>
      
      <ScrollArea className="h-[250px] pr-2 -mr-2">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-t from-[#1C1C1C] to-transparent pointer-events-none" />
    </Card>
  );
};
